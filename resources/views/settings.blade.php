            ...
            <div class="bg-white rounded w-full p-4">
                ...
                <form action="{{ route('my-account.settings') }}" method="post" enctype="multipart/form-data">
                    ...
                    <label for="hs-color-input"
                           class="block text-sm font-medium mb-2">{{ __('settings.primary_color') }}</label>
                    <input type="color" name="primary_color" id="primary_color"
                           ...
                           value="{{ $company->config->get('primary_color') }}" title="Choose your color">
                    <label for="hs-color-input"
                           class="block text-sm font-medium mb-2">{{ __('settings.secondary_color') }}</label>
                    <input type="color" name="secondary_color" id="secondary_color"
                           class="p-1 h-10 w-14 block bg-white border border-gray-200 cursor-pointer rounded-lg disabled:opacity-50 disabled:pointer-events-none"
                           value="{{ $company->config->get('secondary_color') }}" title="Choose your color">
