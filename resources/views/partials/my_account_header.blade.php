        ...
        <div class="flex flex-col">
            ...
            <div class="text-sm font-medium text-center text-gray-500">
                <ul class="flex flex-wrap -mb-px">
                    ...
                    <li class="me-2">
                        <a href="{{ route('my-account.purchased-adverts')}}" class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 @if(request()->routeIs('my-account.purchased-adverts')) text-blue-600 border-blue-600 @endif">{{ __('advert.purchased_adverts') }}</a>
                    </li>
                    <li>
