...
@section('content')
    <div class="flex justify-center space-x-4 mt-8">
        ...
        <form method="GET" action="{{ route('search') }}"
            ...
            <button type="submit" class="bg-blue-500 text-white rounded-full px-4 py-2 ml-auto">                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6">
