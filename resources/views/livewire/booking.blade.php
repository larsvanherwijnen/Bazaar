    ...
    <form wire:submit="save" class="space-y-4">
        ...
        <div class="flex flex-col space-y-4">
            <div>
                ...
                <input type="date" wire:model="start" class="border border-blue-700 rounded w-full pr-2 py-1" >
            ...
            <div>
                ...
                <input type="date" wire:model="end" class="border border-blue-700 rounded w-full pr-2 py-1" >
